		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					...
					<form role="form" class="form-horizontal validate" action="processAddLocation.php" method="POST" id="frmAddLocation" name="frmAddLocation" enctype="multipart/form-data">

				...
				<div class="panel-body">	
					...
					<form role="form" class="form-horizontal validate" action="processAddActivity.php" method="POST" id="frmAddActivity" name="frmAddActivity" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input type="text" name="Date" data-validate="required" data-message-required="Date must not be empty"  class="form-control datepicker" data-format="yyyy-mm-dd">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group input-group-minimal">
									<input type="text" name="Start" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="07:00 AM" data-show-meridian="false" data-minute-step="5" data-second-step="5" />
									<div class="input-group-addon">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group input-group-minimal">
									<input type="text" name="End" class="form-control timepicker" data-template="dropdown" data-show-seconds="true" data-default-time="08:00 AM" data-show-meridian="false" data-minute-step="5" data-second-step="5" />
									<div class="input-group-addon">
										<a href="#"><i class="linecons-clock"></i></a>
									</div>
								</div>
